...
###############################################################################
# @Brief: Function to get robot_commission_request json schema
# @return: json schema, in raw string
def robot_commission_request():
    return r"""
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
...
###############################################################################
# @Brief: Function to get commission json schema
# @return: json schema, in raw string
def commission():
    return r"""
{
...
###############################################################################
# @Brief: Function to get robot_commission_response json schema
# @return: json schema, in raw string
def robot_commission_response():
    return r"""
{
  "$schema": "https://json-schema.org/draft/2020-12/schema",
